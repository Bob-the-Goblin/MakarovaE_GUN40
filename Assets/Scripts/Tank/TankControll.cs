...
//     version 1.7.0
//     from Assets/Settings/TankCntrol.inputactions
//
...
namespace Tank
{
    public partial class @TankCntrol: IInputActionCollection2, IDisposable
    {
    ...
    ""controlSchemes"": []
        ...
        {
            private @TankCntrol m_Wrapper;
            public TankActions(@TankCntrol wrapper) { m_Wrapper = wrapper; }
        ...
        {
            private @TankCntrol m_Wrapper;
            public TurretActions(@TankCntrol wrapper) { m_Wrapper = wrapper; }
